...
This repository contains the source code and implementation for [Writing an OS in 1,000 Lines](https://operating-system-in-1000-lines.vercel.app/) as implemented by [Eric Clothier](https://github.com/shane87).
